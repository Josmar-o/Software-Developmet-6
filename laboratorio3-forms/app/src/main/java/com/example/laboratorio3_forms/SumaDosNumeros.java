...
public class SumaDosNumeros extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainActivity.setOnClickListener(v -> {
            startActivity(new Intent(SumaDosNumeros.this, MainActivity.class));
        });
        ...
        calcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (input1.isEmpty() || input2.isEmpty()) {
                    Toast.makeText(SumaDosNumeros.this, "Ambos campos deben estar llenos", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    Toast.makeText(SumaDosNumeros.this, "Ingresa solo números válidos", Toast.LENGTH_SHORT).show();
                ...
                resultado.setText("Resultado: " + String.format("%.2f", suma));
            }
        });
