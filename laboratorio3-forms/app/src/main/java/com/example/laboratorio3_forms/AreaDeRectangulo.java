...
public class AreaDeRectangulo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_area_de_rectangulo);
        ...
        mainActivity.setOnClickListener(v -> {
            startActivity(new Intent(AreaDeRectangulo.this, MainActivity.class));
        });
        ...
        calcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (input1.isEmpty() || input2.isEmpty()) {
                    Toast.makeText(AreaDeRectangulo.this, "Ambos campos deben estar llenos", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    Toast.makeText(AreaDeRectangulo.this, "Ingresa solo números válidos", Toast.LENGTH_SHORT).show();
                ...
                resultado.setText("El Área es: " + String.format("%.2f", mult));
            }
        });
    }
}